    ...
    for (const user of mongoUsers) {
      try {
        await prisma.user.upsert({
          ...
          create: {
            code: user.code,
            username: user.code, // ใช้ code เป็น username
            name: user.name,
            role: user.role,
            golf_course_id: user.golf_course_id.toString(), // แปลงเป็น string ObjectId
            golf_course_name: `Golf Course ${user.golf_course_id}`, // สร้างชื่อ default
            managed_golf_courses: user.managed_golf_courses || [],
      ...
      try {
        await prisma.vehicle.upsert({
          ...
          update: {
            ...
            golf_course_id: vehicle.golf_course_id?.toString(),
      ...
      try {
        await prisma.job.create({
          data: {
            ...
            golf_course_id: job.golf_course_id.toString(),
            ...
            assigned_to: job.assigned_to ? job.assigned_to.toString() : null,
